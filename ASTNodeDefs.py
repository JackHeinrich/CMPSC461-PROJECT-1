...
class Assignment(ASTNode):
    ...
    def to_string(self):
        expr_str = self.expression.to_string() if isinstance(
            self.expression, ASTNode) else repr(self.expression)
...
class BinaryOperation(ASTNode):
    ...
    def to_string(self):
        left_str = self.left.to_string() if isinstance(
            self.left, ASTNode) else repr(self.left)
        right_str = self.right.to_string() if isinstance(
            self.right, ASTNode) else repr(self.right)
...
class UnaryOperation(ASTNode):
    ...
    def to_string(self):
        operand_str = self.operand.to_string() if isinstance(
            self.operand, ASTNode) else repr(self.operand)
...
class PrintStatement(ASTNode):
    ...
    def to_string(self):
        args_str = ", ".join(arg.to_string() if isinstance(
            arg, ASTNode) else repr(arg) for arg in self.arguments)
...
class ForStatement(ASTNode):
    ...
    def to_string(self):
        start_str = self.start_expr.to_string() if isinstance(
            self.start_expr, ASTNode) else repr(self.start_expr)
        end_str = self.end_expr.to_string() if isinstance(
            self.end_expr, ASTNode) else repr(self.end_expr)
...
class Block(ASTNode):
    ...
    def to_string(self):
        statement_strs = ", ".join(stmt.to_string()
